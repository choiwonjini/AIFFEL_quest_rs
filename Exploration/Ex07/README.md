...
- [x] **1. 주어진 문제를 해결하는 완성된 코드가 제출되었나요?**
  ...
  문장의 답변 내용이 의도와 부합하지는 않지만 한 단어 이상의 문장으로 출력되었다.
...
- [x] **3. 에러가 난 부분을 디버깅하여 문제를 해결한 기록을 남겼거나
      ...
      각 시도 별로 내용을 정리해 두어 변화에 따른 모델 성능 향상을 확인할 수 있었다.
...
- [x] **5. 코드가 간결하고 효율적인가요?**
  ...
  대부분의 코드가 함수화 되어 반복 사용이 가능하도록 하였다.

# 회고(참고 링크 및 코드 개선)

```
# 레이어 수를 변경해보는 것도 좋은 방법인 것 같다.
# 하이퍼파라미터 변경 후 성능 비교를 정리해 두어 해당 변경 사항이 모델의 성능에 얼만큼의 영향을 미쳤는지 확인할 수 있어 좋았다.
```
